...
class AuthorControllerTest {
    ...
    void whenPOSTIsCalledThenStatusCreatedShouldBeReturned() throws Exception {
        AuthorDTO expectedCreatedAuthorDTO = authorDTOBuilder.builAuthorDTO();
        ...
        mockMvc.perform(post(AUTHOR_API_URL_PATH)
            ...
            .content(asJsonString(expectedCreatedAuthorDTO)))
                ...
                .andExpect(jsonPath("$.age", is(expectedCreatedAuthorDTO.getAge().intValue())));
    }
    ...
    void whenGETWithValidIdIsCalledThenStatusOkShouldBeReturned() throws Exception {
        ...
        mockMvc.perform(get(AUTHOR_API_URL_PATH + "/" + expectedFoundAuthorDTO.getId())
            .contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.age", is(expectedFoundAuthorDTO.getAge().intValue())));
    }
    ...
    void whenGETListIsCalledThenStatusOkShouldBeReturned() throws Exception {
        ...
        mockMvc.perform(get(AUTHOR_API_URL_PATH)
            .contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$[0].age", is(expectedFoundAuthorDTO.getAge().intValue())));
    }

    @Test
    void whenDELETEWithValidIdIsCalledThenNotContentShouldBeReturned() throws Exception {
        ...
        doNothing().when(authorService).deleteById(expectedDeletedAuthorId);

        mockMvc.perform(delete(AUTHOR_API_URL_PATH + "/" + expectedDeletedAuthorId)
            .contentType(MediaType.APPLICATION_JSON))
